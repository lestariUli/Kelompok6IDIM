      ...
      <div class="modal-body">
        ...
        <form action="<?= BASEURL; ?>/pembelian/tambah" method="post">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="JumlahPembelian" name="JumlahPembelian" placeholder="Input Jumlah Pembelian">
          </div>

          <div class="form-group">
            <label for="HargaBeli">Harga Beli</label>
            <input type="number" class="form-control" id="HargaBeli" name="HargaBeli" placeholder="Input Harga Beli">
          </div>
